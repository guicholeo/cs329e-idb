document.getElementById("nav_bar").innerHTML =
    ...
    '<body>' +
        '<ul id = "navbar">' +
            ...
            '<li class="navbar_item"><a class="navbar_link" href="../index.html" target="_top">Streamer Surf</a></li>' +
            ...
            '<li class="navbar_item" style="float: right;"><a class="navbar_link" href="../about/about.html" target="_top">About</a><li>' +
